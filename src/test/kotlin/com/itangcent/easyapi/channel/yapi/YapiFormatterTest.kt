...
class YapiFormatterTest {
    ...
    fun testFormatWithTags() {
        val endpoint = ApiEndpoint(
            name = "Get User",
            extensions = MutableExtension().apply { this["tags"] = listOf("user", "admin") },
            metadata = httpMetadata(
                path = "/api/users/{id}",
                method = HttpMethod.GET
            )
    ...
    fun testFormatWithMockWithRules() {
        ...
        val endpoint = ApiEndpoint(
            ...
            metadata = httpMetadata(
                ...
                method = HttpMethod.GET,
                parameters = listOf(
                    ApiParameter(name = "id", binding = ParameterBinding.Path, description = "User ID", extensions = MutableExtension().apply { this["jsonType"] = "integer" })
                )
            )
        )
    ...
    fun testFormatWithMockRulesForQueryParams() {
        ...
        val endpoint = ApiEndpoint(
            ...
            metadata = httpMetadata(
                ...
                method = HttpMethod.GET,
                parameters = listOf(
                    ApiParameter(name = "page", binding = ParameterBinding.Query, extensions = MutableExtension().apply { this["jsonType"] = "integer" }),
                    ApiParameter(name = "size", binding = ParameterBinding.Query, extensions = MutableExtension().apply { this["jsonType"] = "integer" })
                )
            )
        )
    ...
    fun testFormatWithMockNoRulesUsesNameHeuristic() {
        ...
        val endpoint = ApiEndpoint(
            ...
            metadata = httpMetadata(
                ...
                method = HttpMethod.GET,
                parameters = listOf(
                    ApiParameter(name = "email", binding = ParameterBinding.Query, extensions = MutableExtension().apply { this["jsonType"] = "string" })
                )
            )
        )
