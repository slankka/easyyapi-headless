...
class HoppscotchChannel : Channel, IdeaLog {
    ...
    override val settingsType: KClass<out com.itangcent.easyapi.core.settings.Settings> = HoppscotchSettings::class
    ...
    private suspend fun handleAuthErrorWithRefresh(
        ...
        serverUrl: String,
        backendUrl: String?,
        httpClient: com.itangcent.easyapi.core.http.HttpClient,
        hoppscotchConfig: HoppscotchConfig?,
        console: com.itangcent.easyapi.core.logging.IdeaConsole = IdeaConsoleProvider.getInstance(project).getConsole()
    ): ExportResult {
