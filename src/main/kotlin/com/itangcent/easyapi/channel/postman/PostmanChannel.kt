...
class PostmanChannel : Channel, IdeaLog {
    ...
    override val settingsType: KClass<out com.itangcent.easyapi.core.settings.Settings> = PostmanSettings::class
    ...
    override suspend fun export(context: ExportContext): ExportResult {
        ...
        val formatter = PostmanFormatter(
            ...
            options = PostmanFormatOptions(
                ...
                json5FormatType = runCatching { com.itangcent.easyapi.core.settings.PostmanJson5FormatType.valueOf(postmanSettings.postmanJson5FormatType) }.getOrDefault(
                    com.itangcent.easyapi.core.settings.PostmanJson5FormatType.EXAMPLE_ONLY
                ),
    ...
    private suspend fun createModuleCollection(
        ...
        val formatter = PostmanFormatter(
            ...
            options = PostmanFormatOptions(
                ...
                json5FormatType = runCatching { com.itangcent.easyapi.core.settings.PostmanJson5FormatType.valueOf(settings.postmanJson5FormatType) }.getOrDefault(
                    com.itangcent.easyapi.core.settings.PostmanJson5FormatType.EXAMPLE_ONLY
                ),
