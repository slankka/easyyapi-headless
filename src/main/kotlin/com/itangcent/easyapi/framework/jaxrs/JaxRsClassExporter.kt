...
class JaxRsClassExporter(
    ...
    override suspend fun isEnabled(): Boolean =
        FrameworkRegistry.getInstance(project).isEnabled("JAX-RS")
    ...
    private suspend fun exportMethod(
        ...
        resolvedMethod: com.itangcent.easyapi.core.psi.type.ResolvedMethod
    ): List<ApiEndpoint> {
    ...
    private suspend fun extractParamHeaders(resolvedMethod: com.itangcent.easyapi.core.psi.type.ResolvedMethod): List<ApiHeader> {
    ...
    private suspend fun buildParameters(resolvedMethod: com.itangcent.easyapi.core.psi.type.ResolvedMethod): List<ApiParameter> {
